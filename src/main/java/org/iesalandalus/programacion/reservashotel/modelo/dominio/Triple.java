...
public class Triple extends Habitacion{
    ...
    private  void validaNumCamas(){
        if (getNumCamasDobles()<MIN_NUM_CAMAS_DOBLES || getNumCamasDobles()>MAX_NUM_CAMAS_DOBLES){
            throw new IllegalArgumentException("ERROR: El número de camas dobles de una habitación triple no puede ser inferior a 0 ni mayor que 2");
        }
        if (getNumCamasIndividuales()<MIN_NUM_CAMAS_INDIVIDUALES || getNumCamasIndividuales()>MAX_NUM_CAMAS_INDIVIDUALES){
            throw new IllegalArgumentException("ERROR: El número de camas individuales de una habitación triple no puede ser inferior a 0 ni mayor que 3");
        }
        ...
        throw new IllegalArgumentException("ERROR: La distribución de camas en una habitación triple tiene que ser 3 camas individuales y 0 doble o 0 cama individual y 2 doble");
    ...
    public String toString() {
        return  String.format(super.toString() + ", habitación triple, capacidad=%d personas, baños=%d, camas individuales=%d, camas dobles=%d" ,getNumeroMaximoPersonas(),numBanos, numCamasIndividuales,numCamasDobles);
